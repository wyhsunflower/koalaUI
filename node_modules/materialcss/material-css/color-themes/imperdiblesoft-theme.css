	...
	/* -------------------------------------------------------------------------------------- */
	/* --- ImperdibleSoft Theme							----------------------------------- */
	/* --- Created by: Imperdiblesoft					----------------------------------- */
	/* -------------------------------------------------------------------------------------- */
	/* --- Main color:						#2b8d17;		----------------------------------- */
	/* --- Main color clicked:				#257a14;		----------------------------------- */
	/* --- Main color bg: 					#94C38A;		----------------------------------- */
	/* --- Secondary color:				#257a14;		----------------------------------- */
	/* --- Secondary color clicked:	#2b8d17;		----------------------------------- */
	/* --- Secondary color bg:			#94C38A;		----------------------------------- */
	/* -------------------------------------------------------------------------------------- */
...
.mc-spinner{
	background: -moz-linear-gradient(left, #2b8d17 10%, rgba(255, 255, 255, 0) 85%);
	background: -webkit-linear-gradient(left, #2b8d17 10%, rgba(255, 255, 255, 0) 85%);
	background: -o-linear-gradient(left, #2b8d17 10%, rgba(255, 255, 255, 0) 85%);
	background: -ms-linear-gradient(left, #2b8d17 10%, rgba(255, 255, 255, 0) 85%);
	background: linear-gradient(to right, #2b8d17 10%, rgba(255, 255, 255, 0) 85%);
}
.mc-spinner:after{
...
@media only screen and (min-width: 721px){
	...
	body > .mc-navigation .mc-header-menu .mc-title, body > .mc-navigation .mc-nav-item, body > .mc-navigation .mc-nav-subitem{
		color: #FFFFFF;
	}
	body > .mc-navigation .mc-nav-item:hover, body > .mc-navigation .mc-nav-subitem:hover{
		background-color: #2b8d17;
	}

	/*	NAVIGATION ICONS	*/
	body > .mc-navigation .mc-nav-item[mc-action="menu"]{
		background-image: url('../material-icons/mc-menu-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="help"]{
		background-image: url('../material-icons/mc-help-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="info"]{
		background-image: url('../material-icons/mc-info-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="home"]{
		background-image: url('../material-icons/mc-home-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="gallery"]{
		background-image: url('../material-icons/mc-gallery-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="prev"]{
		background-image: url('../material-icons/mc-prev-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="next"]{
		background-image: url('../material-icons/mc-next-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="scroll-top"]{
		background-image: url('../material-icons/mc-scrolltop-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="scroll-down"]{
		background-image: url('../material-icons/mc-scrollbottom-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="done"]{
		background-image: url('../material-icons/mc-done-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="search"]{
		background-image: url('../material-icons/mc-search-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="refresh"]{
		background-image: url('../material-icons/mc-refresh-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="cancel"]{
		background-image: url('../material-icons/mc-cancel-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="options-h"]{
		background-image: url('../material-icons/mc-options-h-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="options-v"]{
		background-image: url('../material-icons/mc-options-v-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="settings"]{
		background-image: url('../material-icons/mc-settings-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="add"]{
		background-image: url('../material-icons/mc-add-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="edit"]{
		background-image: url('../material-icons/mc-edit-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="undo"]{
		background-image: url('../material-icons/mc-undo-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="redo"]{
		background-image: url('../material-icons/mc-redo-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="delete"]{
		background-image: url('../material-icons/mc-delete-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="remove"]{
		background-image: url('../material-icons/mc-remove-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="upload"]{
		background-image: url('../material-icons/mc-upload-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="download"]{
		background-image: url('../material-icons/mc-download-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="sync"]{
		background-image: url('../material-icons/mc-sync-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="favorite"]{
		background-image: url('../material-icons/mc-favorite-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="like"]{
		background-image: url('../material-icons/mc-like-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="share"]{
		background-image: url('../material-icons/mc-share-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="send"]{
		background-image: url('../material-icons/mc-send-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="comment"]{
		background-image: url('../material-icons/mc-comment-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="colors"]{
		background-image: url('../material-icons/mc-colors-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="text"]{
		background-image: url('../material-icons/mc-text-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="button"]{
		background-image: url('../material-icons/mc-button-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="cards"]{
		background-image: url('../material-icons/mc-cards-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="icon"]{
		background-image: url('../material-icons/mc-icon-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="navigation"]{
		background-image: url('../material-icons/mc-navigation-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="location"]{
		background-image: url('../material-icons/mc-location-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="email"]{
		background-image: url('../material-icons/mc-email-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="phone"]{
		background-image: url('../material-icons/mc-phone-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="message"]{
		background-image: url('../material-icons/mc-message-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="user"]{
		background-image: url('../material-icons/mc-user-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="list"]{
		background-image: url('../material-icons/mc-list-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="layout"]{
		background-image: url('../material-icons/mc-layout-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="popup"]{
		background-image: url('../material-icons/mc-popup-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="cut"]{
		background-image: url('../material-icons/mc-cut-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="copy"]{
		background-image: url('../material-icons/mc-copy-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="paste"]{
		background-image: url('../material-icons/mc-paste-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="arrow-down"]{
		background-image: url('../material-icons/mc-arrow-down-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="picker"]{
		background-image: url('../material-icons/mc-picker-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="account"]{
		background-image: url('../material-icons/mc-account-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="forums"]{
		background-image: url('../material-icons/mc-forums-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="notifications"]{
		background-image: url('../material-icons/mc-notifications-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="external"]{
		background-image: url('../material-icons/mc-external-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="play"]{
		background-image: url('../material-icons/mc-play-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="pause"]{
		background-image: url('../material-icons/mc-pause-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="stop"]{
		background-image: url('../material-icons/mc-stop-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="music-next"]{
		background-image: url('../material-icons/mc-music-next-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="music-prev"]{
		background-image: url('../material-icons/mc-music-previous-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="playlist"]{
		background-image: url('../material-icons/mc-playlist-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="volume-up"]{
		background-image: url('../material-icons/mc-volume-up-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="volume-down"]{
		background-image: url('../material-icons/mc-volume-down-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="volume-off"]{
		background-image: url('../material-icons/mc-volume-off-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="facebook"]{
		background-image: url('../material-icons/mc-facebook-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="google-plus"]{
		background-image: url('../material-icons/mc-google-plus-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="twitter"]{
		background-image: url('../material-icons/mc-twitter-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="whatsapp"]{
		background-image: url('../material-icons/mc-whatsapp-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="instagram"]{
		background-image: url('../material-icons/mc-instagram-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="youtube"]{
		background-image: url('../material-icons/mc-youtube-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="soundcloud"]{
		background-image: url('../material-icons/mc-soundcloud-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="imperdiblesoft"]{
		background-image: url('../material-icons/mc-imperdiblesoft-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="skype"]{
		background-image: url('../material-icons/mc-skype-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="linkedin"]{
		background-image: url('../material-icons/mc-linkedin-dark.png');
	}
	body > .mc-navigation .mc-nav-item[mc-action="github"]{
		background-image: url('../material-icons/mc-github-dark.png');
	}
