	...
	/* -------------------------------------------------------------------------------------- */
	/* --- Main color:						#009688;		----------------------------------- */
	/* --- Main color clicked:				#00796B;		----------------------------------- */
	/* --- Main color bg: 					#80CBC4;		----------------------------------- */
	/* --- Secondary color:				#FF5722;		----------------------------------- */
	/* --- Secondary color clicked:	#E64A19;		----------------------------------- */
	/* --- Secondary color bg:			#FFAB91;		----------------------------------- */
	/* -------------------------------------------------------------------------------------- */
...
.mc-spinner{
	background: -moz-linear-gradient(left, #FF5722 10%, rgba(255, 255, 255, 0) 85%);
	background: -webkit-linear-gradient(left, #FF5722 10%, rgba(255, 255, 255, 0) 85%);
	background: -o-linear-gradient(left, #FF5722 10%, rgba(255, 255, 255, 0) 85%);
	background: -ms-linear-gradient(left, #FF5722 10%, rgba(255, 255, 255, 0) 85%);
	background: linear-gradient(to right, #FF5722 10%, rgba(255, 255, 255, 0) 85%);
}
.mc-spinner:after{
